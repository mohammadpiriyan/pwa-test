...
function App() {
  return (
    <div className="App">
      <div className="h-screen w-screen bg-blue-200 flex flex-col justify-center items-center gap-8">
        <div>
          <button
            className="px-8 py-3 rounded-xl border bg-blue-100"
            onClick={() => {
        ...
        <div className="flex justify-center items-center gap-8">
          <button className="px-8 py-3 rounded-xl border bg-blue-100">
            change theme
          </button>
          <select className="px-8 py-3 rounded-xl border bg-blue-100">
